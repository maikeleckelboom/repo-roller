      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            name: 'scan',
            type: 'string',
            description: 'Quick scan via daemon (uses cache)',
            category: 'daemon',
          },
          {
            flags: '--bundle [root]',
            name: 'bundle',
            type: 'string',
            description: 'Generate bundle via daemon',
            category: 'daemon',
          },
          {
            flags: '--tokens [root]',
            name: 'tokens',
            type: 'string',
            description: 'Quick token estimate via daemon',
            category: 'daemon',
          },
          {
            flags: '--cache',
          ...
          },
          {
            ...
            name: 'rpc',
            type: 'string',
            description: 'Send raw RPC method to daemon',
            category: 'daemon',
          },
        ],
        examples: [
